...
<form action="/Servlet" method="post">
    ...
    <p>Enter communal account (8 numbers):</p>
    <p><input type="text" size="3" maxlength="4" name="communalIDPart1">
        <input type="text" size="3" maxlength="4" name="communalIDPart2"></p>
    ...
    <input type="hidden" value="communalPaymentConfirm" name="actionType"/>
